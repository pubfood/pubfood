...
(function(f) {
    ...
    return (function e(t, n, r) {
        ...
        9: [function(require, module, exports) {
            ...
            AuctionMediator.AUCTION_TYPE = {
                START: 'init',
                REFRESH: 'refresh'
            };
            AuctionMediator.IN_AUCTION = {
                FALSE: false,
                PENDING: 'pending',
                DONE: 'done'
            };
            ...
            AuctionMediator.prototype.validate = function(isRefresh) {
                ...
                var tst = {
                    ...
                    hasBidProviders: function() {
                        ...
                        /* eslint-enable no-unused-vars */
                        if (!ret) {
                            Event.publish(Event.EVENT_TYPE.WARN, {
                    ...
                    hasAllSlotsBidder: function() {
                        ...
                        if (noBidders.length > 0) {
                            Event.publish(Event.EVENT_TYPE.WARN, {
                                msg: 'Warn: no bidders - ' + noBidders.join(', ')
                            });
                        }
                ...
                for (var k in tst) {
                    ...
                    if (!isValid) {
                        Event.publish(Event.EVENT_TYPE.INVALID, {
                            msg: 'Failed: ' + k
                        });
                        break;
                    }
 ...
 */
            ...
            AuctionMediator.prototype.auctionDone = function(auctionIdx, data) {
                ...
                Event.publish(Event.EVENT_TYPE.AUCTION_COMPLETE, {
                    name: data,
                    targeting: auctionTargeting
                });
                setTimeout(function() {
        ...
        12: [function(require, module, exports) {
            ...
            AuctionProvider.withDelegate = function(delegate) {
                if (!AuctionProvider.validate(delegate)) {
                    Event.publish(Event.EVENT_TYPE.INVALID, {
                        msg: 'Warn: invalid auction delegate - ' + (delegate && JSON.stringify(delegate)) || ''
                    });
                    return null;
                }
        ...
        13: [function(require, module, exports) {
            ...
            BidProvider.withDelegate = function(delegate) {
                if (!BidProvider.validate(delegate)) {
                    Event.publish(Event.EVENT_TYPE.WARN, {
                        msg: 'Warn: invalid bidder delegate - ' + delegate || ''
                    });
                    return null;
                }
            ...
            var util = {
                ...
                validate: function(type, obj) {
                    ...
                    for (var k in type) {
                        ...
                        if (valType === 'null' || valType === 'undefined' || (valType === 'number' && !isFinite(obj[k])) || (valType === 'string' && obj[k] === '')) isSet = false;

                        if (!isOpt && (!hasProp || !isSet))++err;

                        if (isSet && isModel && (util.isArray(obj[k]) && obj[k].length === 0))++err;
